<div id="mainBody">
	...
	<div class="row">	  
			...
			<div class="span6">
				<h3><?php echo $proDetails->product_name?> </h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><?php echo $proDetails->product_price?></span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Qty."/>
					  <button class="btn btn-large btn-primary pull-right"><a href="<?php echo base_url('Product/addToCart/'.$proDetails->product_id); ?>"> Add to cart </a><i class=" icon-shopping-cart"></i></button>
					</div>
				  </div>
				</form>
