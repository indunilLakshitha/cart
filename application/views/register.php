	...
	<!-- <form class="form-horizontal" > -->
		...
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <?php echo form_input(array('name'=>'username','id'=>'inputUname','placeholder'=>'Username'))?>
		...
		<div class="control-group">
			...
			<div class="controls">
			  ...
			  <?php echo form_input(array('name'=>'firstname','id'=>'inputFname','placeholder'=>'First Name'))?>
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  ...
			  <?php echo form_input(array('name'=>'lastname','id'=>'inputLname','placeholder'=>'Last Name'))?>
		...
		<div class="controls">
		  ...
		  <?php echo form_input(array('name'=>'email','id'=>'inputEmail','placeholder'=>'Email'))?>
	...
	<div class="control-group">
		...
		<div class="controls">
		  ...
		  <?php echo form_password(array('name'=>'password','id'=>'inputpassword','placeholder'=>'Password'))?>
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		  <!-- <input type="password" id="mobile" placeholder="Mobile"> -->
		  <?php echo form_input(array('name'=>'mobile','id'=>'inputMobile','placeholder'=>'Mobile'))?>
	...
	<div class="alert alert-block alert-error fade in">
		<button type="button" class="close" data-dismiss="alert">×</button>
		<strong><?php echo $this->session->flashdata('signupSuccess');?>
	 </div>	
	<?php }?>
